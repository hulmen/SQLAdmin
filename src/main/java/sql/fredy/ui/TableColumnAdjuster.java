...
Important:
----------
I've got this code from http://www.camick.com/java/source/TableColumnAdjuster.java


 */
import applications.basics.SqlMonitor;
import java.awt.*;
...
public class TableColumnAdjuster implements PropertyChangeListener, TableModelListener {
    ...
    public void adjustColumn(final int column) {
        ...
        //System.out.println("Column: " + column + " Width: " + preferredWidth);
        int prefWidth = sql.fredy.sqltools.SqlMonitor.getColumnWidth();

        if ((prefWidth != 0) && (preferredWidth > prefWidth)) {
