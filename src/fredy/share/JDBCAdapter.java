...
public class JDBCAdapter extends AbstractTableModel {
    ...
    public JDBCAdapter(String host,
        ...
        initMaxRowCount();
        t_connect con = new t_connect(host, user, password, db);
        if (con.getError() != null) {
            System.err.println("Cannot connect to the Database:" + con.getError());
            logger.log(Level.SEVERE, "Can not connect to database. " + con.getError());
        }
        statement = con.stmt;
        connection = con.con;
    ...
    public JDBCAdapter(t_connect con) {
        statement = con.stmt;
        connection = con.con;
        standalone = false;
        initMaxRowCount();
            ...
            switch (getMetaData().getColumnType(i)) {
                ...
                case Types.TINYINT:
                    ...
                    if (wasNull) {
                        ...
                        integer = new Integer(resultSet.getInt(i));
                ...
                case Types.BIGINT:
                    ...
                    if (wasNull) {
                        ...
                        Long lnog = new Long(resultSet.getLong(i));
                        co.setObject(lnog);
                ...
                case Types.DECIMAL:
                    ...
                    if (wasNull) {
                        ...
                        Float flo = new Float(resultSet.getFloat(i));
                        co.setObject(flo);
                ...
                case Types.FLOAT:
                    ...
                    if (wasNull) {
                        ...
                        Float flo2 = new Float(resultSet.getFloat(i));
                        co.setObject(flo2);
                ...
                case Types.DOUBLE:
                    ...
                    if (wasNull) {
                        ...
                        Double dob = new Double(resultSet.getDouble(i));
                        co.setObject(dob);
                ...
                case Types.REAL:
                    ...
                    if (wasNull) {
                        ...
                        Float flo3 = new Float(resultSet.getFloat(i));
                        co.setObject(flo3);
